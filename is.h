...
isImageBufType *isGetImageBufFromKey(isWorkerContext_t *ibctx, char *key);
isImageBufType *isGetRawImageBuf(isWorkerContext_t *ibctx, json_t *job);
isImageBufType *isReduceImage(isWorkerContext_t *ibctx, json_t *job);
